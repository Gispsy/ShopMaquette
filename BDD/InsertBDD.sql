...
(16, 4, 5, 'acetaminophen, dextromethorphan hydrobromide and doxylamine succinate liquid', 16, 'Open wound of right buttock', 16),
...
(38, 5, 1, 'Adrenalinuhosphoricum, Kali phosphoricum, Paullinia sorbilis, Thea sinensis', 38, 'Displ commnt fx l patella, 7thF', 38),
...
INSERT INTO Commande (ComId, ComRef, ComTVA, ComDateLivraison, ComDateCommande, ComAdresse, ComVille, ComCp, ComAdressFactu, BonDate, BonTVA, BonPrixHT, BonTotalPrixHT, BonTVATotal, CliId, ComQuantiter, ProId)
VALUES
(1, 1, 35, '2022-10-09', '2023-02-18', 'Apt 814', 'Seremban', '70690', 'Room 881', '2022-07-25', 34, 4.40, 6.95, 36, 1, 1, 1),
(2, 2, 24, '2022-08-22', '2022-11-24', 'PO Box 23241', 'Rio Grande da Serra', '09450-000', 'Suite 13', '2022-12-26', 66, 2.04, 1.45, 89, 2, 2, 2),
(3, 3, 26, '2022-08-18', '2022-12-25', 'PO Box 80331', 'Gobojango', '8000', '4th Floor', '2022-08-18', 85, 7.40, 0.21, 96, 3, 3, 3),
(4, 4, 99, '2022-12-02', '2022-12-19', '5th Floor', 'Vila Alva', '7940-374', 'PO Box 98231', '2022-07-31', 73, 2.45, 6.43, 86, 4, 4, 4),
(5, 5, 51, '2022-05-04', '2023-02-26', '16th Floor', 'Madalena do Mar', '9360-413', 'PO Box 36213', '2022-09-01', 85, 8.41, 1.03, 73, 5, 5, 5);

INSERT INTO BonLivraison (BonLivID, BonLivClientNum, BonLivClientAdresseMail, BonLivClientRef, BonLivClientNom, BonLivClientAdresse, BonLivComAdresse, BonLivComDate, BonLivComRef, BonLivProduitRef, BonLivQuantiter, ComId, ProId, CliID)
VALUES
